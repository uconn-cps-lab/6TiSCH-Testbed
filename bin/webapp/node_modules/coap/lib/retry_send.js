...
function RetrySend(sock, port, host, dtls) {  //fengmo DTLS
...
RetrySend.prototype._send = function(avoidBackoff) {
  ...
  var ackSent = function(err, bytes) 
  {
   ...
   var rsinfo = {address: this._host, port: this._port};
   this.dtls.encrypt(this._message, rsinfo, function (encmsg, rsinfo)
   {
