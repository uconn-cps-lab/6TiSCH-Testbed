 ...
 */
coap_attr_t *coap_add_attr(coap_resource_t *resource, const unsigned char *name,
		size_t nlen, const unsigned char *val, size_t vlen, int flags);
...
/**
 * Remove all existing subscribers from all observable resource
 */
